...
- `sed` - Sanitización automática de direccionamiento IP y direcciones MAC para informes de auditoría.

## 📜 Automatización y Evidencias
- **Script:** `scripts/network_collector.sh` (Recolección automatizada de la configuración de red).
- **Evidencia:** `evidence/network_info.txt` (Reporte sanitizado con direccionamiento de laboratorio `10.0.0.x`).
